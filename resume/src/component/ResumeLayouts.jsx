export default function ResumeLayouts({children,id,col="12",classname="",flex="",bgColor="",marginB="2px",paddingT="0",paddingB="0",paddingR="0",paddingL="0",height="",forPic=0}){
    switch(col){
        case "1":
    ...
    if(flex==="yes")
        flex="flex";
return(
        <div className={""+classname} id={"resumeLayout"+id} style={{marginBottom:marginB,paddingBottom:paddingT,paddingLeft:paddingL,paddingRight:paddingR,background:bgColor,height:height}}>
